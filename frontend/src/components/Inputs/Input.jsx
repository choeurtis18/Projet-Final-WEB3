...
const Input = ({ label, type, onChange, value, id, placeholder }) => {
  return (
    <div className='mb-4'>
      ...
      <input className="border text-base font-light text-dark_primary_first rounded-md p-2 focus:outline-none focus:border-dark-primary-first w-64 bg-lighter_primary_first" required
