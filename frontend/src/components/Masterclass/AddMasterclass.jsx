...
export default function AddMasterclass() {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      addMasterclass(masterclassTitle, masterclassDescription, masterclassCertification.value, 
        masterclassInstrument.value, masterclassComposer.value).then(data => {
    ...
    return (
      <div className="p-6 flex flex-wrap">
        ...
        <form className='bg-white w-full shadow-shadow_3 rounded px-6 py-2' onSubmit={handleSubmit}>
          <h2 htmlFor='message' className='my-2 form-label text-xl font-black'>Ajoutez une Masterclass</h2>
          <div className="mb-4">
